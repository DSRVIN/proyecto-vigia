...
export const COURSE_EVALUATIONS = {
  SIST101: [
    { key: 'pc1', label: 'PC1', weight: 0.20 },
    { key: 'pc2', label: 'PC2', weight: 0.20 },
    { key: 'proyectoFinal', label: 'Proyecto Final', weight: 0.30 },
    { key: 'examenFinal', label: 'Examen Final', weight: 0.30 },
  ],
  SIST102: [
    { key: 'avance1', label: 'Avance Proyecto 1', weight: 0.15 },
    { key: 'avance2', label: 'Avance Proyecto 2', weight: 0.15 },
    { key: 'proyectoFinal', label: 'Proyecto Final', weight: 0.30 },
    { key: 'examenFinal', label: 'Examen Final', weight: 0.40 },
  ],
  SIST103: [
  ...
  SIST104: [
    { key: 'avance1', label: 'Avance 1', weight: 0.10 },
    { key: 'avance2', label: 'Avance 2', weight: 0.20 },
    { key: 'sustentacion', label: 'Sustentación', weight: 0.30 },
    { key: 'informeFinal', label: 'Informe Final', weight: 0.40 },
  ],
  SIST105: [
    { key: 'prototipo1', label: 'Prototipo 1', weight: 0.15 },
    { key: 'prototipo2', label: 'Prototipo 2', weight: 0.20 },
    { key: 'pc', label: 'PC', weight: 0.25 },
    { key: 'examenFinal', label: 'Examen Final', weight: 0.40 },
  ],
  SIST106: [
    { key: 'ejercicios', label: 'Ejercicios', weight: 0.10 },
    { key: 'pc1', label: 'PC1', weight: 0.20 },
    { key: 'pc2', label: 'PC2', weight: 0.20 },
    { key: 'proyecto', label: 'Proyecto', weight: 0.50 },
  ],
  SIST107: [
    { key: 'participacion', label: 'Participación', weight: 0.10 },
    { key: 'trabajoParcial', label: 'Trabajo Parcial', weight: 0.20 },
    { key: 'trabajoFinal', label: 'Trabajo Final', weight: 0.30 },
    { key: 'examen', label: 'Examen', weight: 0.40 },
  ],
  SIST108: [
    { key: 'foros', label: 'Foros', weight: 0.10 },
    { key: 'pc', label: 'PC', weight: 0.20 },
    { key: 'trabajoAplicativo', label: 'Trabajo Aplicativo', weight: 0.30 },
    { key: 'examenFinal', label: 'Examen Final', weight: 0.40 },
  ],
  SIST109: [
    { key: 'talleres', label: 'Talleres', weight: 0.10 },
    { key: 'pc1', label: 'PC1', weight: 0.20 },
  ...
  EDUC201: [
    ...
    { key: 'informeFinal', label: 'Informe Final', weight: 0.30 },
    { key: 'examen', label: 'Examen', weight: 0.40 },
  ],
  EDUC202: [
  ...
  EDUC203: [
    { key: 'foros', label: 'Foros', weight: 0.10 },
    { key: 'trabajoGrupal', label: 'Trabajo Grupal', weight: 0.20 },
    { key: 'pc', label: 'PC', weight: 0.30 },
    { key: 'examenFinal', label: 'Examen Final', weight: 0.40 },
  ],
  EDUC204: [
    { key: 'avance1', label: 'Avance 1', weight: 0.15 },
    { key: 'avance2', label: 'Avance 2', weight: 0.15 },
    { key: 'disenoFinal', label: 'Diseño Final', weight: 0.30 },
    { key: 'examen', label: 'Examen', weight: 0.40 },
  ],
  EDUC205: [
    { key: 'practicas', label: 'Prácticas', weight: 0.10 },
    { key: 'proyectoAula', label: 'Proyecto Aula', weight: 0.20 },
    { key: 'pc', label: 'PC', weight: 0.30 },
    { key: 'examenFinal', label: 'Examen Final', weight: 0.40 },
  ],
  EDUC206: [
  ...
  EDUC207: [
    { key: 'participacion', label: 'Participación', weight: 0.10 },
    { key: 'trabajoAplicativo', label: 'Trabajo Aplicativo', weight: 0.20 },
    { key: 'pc', label: 'PC', weight: 0.30 },
    { key: 'examenFinal', label: 'Examen Final', weight: 0.40 },
  ],
  EDUC208: [
    ...
    { key: 'borradorTesis', label: 'Borrador Tesis', weight: 0.30 },
    { key: 'sustentacion', label: 'Sustentación', weight: 0.40 },
  ],
  EDUC209: [
    { key: 'debates', label: 'Debates', weight: 0.10 },
    { key: 'ensayo', label: 'Ensayo', weight: 0.20 },
    { key: 'pc', label: 'PC', weight: 0.30 },
    { key: 'examenFinal', label: 'Examen Final', weight: 0.40 },
  ],
};
